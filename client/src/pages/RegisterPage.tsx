        ...
        <form onSubmit={handleSubmit} className="relative bg-white m-auto h-fit w-full max-w-sm overflow-hidden rounded-xl border border-gray-200 shadow-[0_10px_30px_rgba(0,0,0,0.15)]" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
          <div className="bg-white p-6 pb-4" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
            <div className="text-center">
              ...
              <h1 className="mb-1 mt-3 text-xl font-semibold">Create your account</h1>
              <p className="text-sm text-gray-600">Join KisanSetu by creating your account</p>
            </div>
            ...
            <div className="mt-4 space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-md bg-kisan-green py-2 text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-kisan-green disabled:opacity-50"
              >
          ...
          <div className="p-3 border-top border-t border-gray-200 bg-white">
            <p className="text-center text-sm text-gray-700">
              Already have an account?
              <Link to="/login" className="px-2 text-kisan-green hover:text-green-600">Sign in</Link>
            </p>
          </div>
        </form>
      </section>
